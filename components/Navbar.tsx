    ...
    <header className="fixed inset-x-0 top-0 z-30 border-b border-emerald-100/70 bg-mint-50/80 backdrop-blur-md">
      <div className="mx-auto max-w-6xl px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-3">
          <Link
            href="#top"
            className="inline-flex items-center gap-2.5 font-sans text-[1.0625rem] font-medium leading-none text-[#111827] sm:gap-3 sm:text-xl"
          >
            ...
            <Image
              ...
              width={640}
              height={640}
              className="h-[4.25em] w-auto shrink-0 translate-y-[0.02em] object-contain object-center mix-blend-multiply [image-rendering:crisp-edges]"
              priority
              aria-hidden
            />
          </Link>
