...
export function Hero({ onCadastreCaptured }: HeroProps) {
  ...
  return (
    <section id="top" className="relative flex min-h-screen items-center justify-center bg-mint-50">
      ...
      {/* Немного поднимаем hero-содержимое */}
      <div className="relative z-10 mt-[56px] flex w-full max-w-5xl flex-col items-center px-4 pb-16 pt-7 text-center sm:px-6 lg:px-8">
